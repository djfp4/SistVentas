<?php
  include '../Login/verificarSesion.php';
?>
<html>
<head>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <a class="navbar-brand" href="#"><img src="../Imagenes/logotipo.png" width="55" height="55"></a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
                 ...
                 <li><button class="btn btn-link"></button></li>
                 <li class="nav-item active"><a class="btn btn-primary" href="../Formularios/ventas.php"><img src="../Imagenes/vender.png" width="40" height="40"><span class="sr-only">(current)</span></a></li>
                 <li><button class="btn btn-link"></button></li>
                 <li class="nav-item active"><a class="btn btn-danger" href="../Login/logout.php"><img src="../Imagenes/cerrar1.png" width="40" height="40"><span class="sr-only">(current)</span></a></li>
