...
$res=mysqli_query($con,"SELECT p.nomProd, d.nomProductor, d.det_cant, d.fec_reg, d.idProd, d.id_det from det_prod d inner join producto p on p.idProd=d.idProd where p.idProd = $qpro order by fec_reg desc");
	echo "<div class='container'>";
	echo "<hr width=250><center><h1>Productores</h1></center><hr width=250>";
	?>
	<center>
	<table>
		<form action="rep_productor.php">
