<?php 
  ...
  $fecf=$_REQUEST['fecf'];
	...
	$res=mysqli_query($con,"SELECT p.nomProd, d.nomProductor, d.det_cant, d.fec_reg, d.idProd, d.id_det from det_prod d inner join producto p on p.idProd=d.idProd where  d.fec_reg >= '$feci' and d.fec_Reg <= '$fecf' order by d.nomProductor");
  if ($feci>$fecf) 
  {
